...
import 'package:musiz_player/ui/colors.dart' as ui_colors;
...
class ThemeManager extends ChangeNotifier {
  ...
  Color _accentColor = Color(
    box.get('accentColor', defaultValue: ui_colors.accentColor.value),
  );
  ...
  bool _isRightToLeftDirection = box.get(
