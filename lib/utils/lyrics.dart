...
import 'package:musiz_player/utils/spotify.dart';
...
class Lyrics {
  ...
  Future<String> getSaavnLyrics(String id) async {
    try {
      ...
      final String lyrics = fetchedLyrics['lyrics'].toString().replaceAll(
        '<br>',
        '\n',
      );
      return lyrics;
  ...
  Future<Map<String, String>> getSpotifyLyricsFromId(String trackId) async {
    final Map<String, String> result = {
      'lyrics': '',
      'type': 'text',
      'source': 'Spotify',
...
bool matchSongs({
  ...
  Logger.root.info(
    'TitleMatched: $titleMatched, ArtistMatched: $artistMatched',
  );
