...
ThemeData lightTheme(accentColor) => ThemeData.light().copyWith(
  ...
  tabBarTheme: TabBarTheme(labelColor: Colors.grey[200]),
  bottomSheetTheme: const BottomSheetThemeData(
    backgroundColor: Color.fromARGB(255, 247, 247, 247),
  ),
  textSelectionTheme: TextSelectionThemeData(selectionHandleColor: accentColor),
  shadowColor: Colors.black.withOpacity(0.08),
  navigationBarTheme: NavigationBarThemeData(indicatorColor: accentColor),
