...
import 'package:musiz_player/api/api.dart';
import 'package:musiz_player/api/extensions.dart';
import 'package:musiz_player/api/ytmusic.dart';
...
class _MainSearchScreenState extends State<MainSearchScreen>
  ...
  searchSaavn(String query) async {
    Map<dynamic, dynamic> songSearchResults = await SaavnAPI()
        .fetchSongSearchResults(searchQuery: query, count: 5);
    List<Map<dynamic, dynamic>> searchResults = await SaavnAPI()
